      ...
      item: [
        ...
        },
        {
          ...
          request: {
            ...
            description: "Initiates password reset by sending a 6-digit OTP to the registered email."
          },
          response: []
        },
        {
          ...
          request: {
            ...
            description: "Resets account password using 6-digit OTP code and revokes all active sessions."
          },
          response: []
        },
        {
          ...
          request: {
            ...
            description: "Changes password for logged in user. Validates current password and updates to new password."
          },
          response: []
        }
      ]
